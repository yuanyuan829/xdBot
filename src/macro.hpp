...
struct Macro : xdgdr::Replay<Macro, input> {
...
public:
    ...
    static bool loadGDR2File(std::filesystem::path path);
    ...
    static uint32_t getLevelId();
    static void setLevelInfo(const std::string& name, uint32_t id);
